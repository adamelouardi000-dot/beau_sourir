...
public class NotificationRepoImpl implements NotificationRepo {
    ...
    public void create(Notification n) {
        ...
        try (Connection c = SessionFactory.getInstance().getConnection();
            ...
            ps.setDate(9, Date.valueOf(n.getDateCreation() != null ? n.getDateCreation() : LocalDate.now()));
            ps.setTimestamp(10, Timestamp.valueOf(n.getDateDerniereModification() != null ? n.getDateDerniereModification() : LocalDateTime.now()));
    ...
    // ---------------- Helper interne (simple, sans framework) ----------------
